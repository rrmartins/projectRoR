...
ActiveRecord::Schema.define(:version => 20110804223705) do
  ...
  create_table "qualificacaos", :force => true do |t|
  ...
  create_table "qualificaoes", :force => true do |t|
    t.integer  "cliente_id"
    t.integer  "restaurante_id"
    t.float    "nota"
    t.float    "valor_gasto"
  ...
  add_index "qualificaoes", ["cliente_id"], :name => "index_qualificaoes_on_cliente_id"
  add_index "qualificaoes", ["restaurante_id"], :name => "index_qualificaoes_on_restaurante_id"
